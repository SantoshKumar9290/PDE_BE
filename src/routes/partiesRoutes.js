...
router.post('/',verifyjwt, roleAuthorization([Roles.Role_User, Roles.Role_Sro,Roles.Role_CSC]), validateSchema(createPartiesSchema), [handler.createParties]);
router.put('/',verifyjwt, roleAuthorization([Roles.Role_User,Roles.Role_Sro,Roles.Role_CSC]), validateSchema(updatePartiesSchema), [handler.updateParties]);
router.put('/updatePresenter',verifyjwt, roleAuthorization([Roles.Role_User,Roles.Role_Sro,Roles.Role_CSC]), [handler.updatePresenter]);
router.delete('/representative/:documentId/:partyId/:parentPartyId',verifyjwt, roleAuthorization([Roles.Role_User,Roles.Role_Sro,Roles.Role_CSC]), [handler.deleteRepresentative]);
router.delete('/:applicationId/:id',verifyjwt, roleAuthorization([Roles.Role_User,Roles.Role_Sro,Roles.Role_CSC]), [handler.deleteParties]);
router.post('/representative',verifyjwt, roleAuthorization([Roles.Role_User, Roles.Role_Sro,Roles.Role_CSC]), [handler.createRepresentative]);
