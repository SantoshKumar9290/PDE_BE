...
router.post('/',verifyjwt,roleAuthorization([Roles.Role_User,Roles.Role_Sro,Roles.Role_CSC]),[handler.createProperty]);
router.post('/section47a',verifyjwt,roleAuthorization([Roles.Role_User,Roles.Role_Sro,Roles.Role_CSC]),[handler.createSection47A]);
...
router.put('/:applicationId/:propertyId',verifyjwt, roleAuthorization([Roles.Role_User,Roles.Role_Sro,Roles.Role_CSC],true),[handler.editProperty])
router.delete('/:applicationId/:propertyId',verifyjwt, roleAuthorization([Roles.Role_User,Roles.Role_Sro,Roles.Role_CSC]), [handler.deleteProperty]);
router.post('/others',verifyjwt, roleAuthorization([Roles.Role_User,Roles.Role_Sro,Roles.Role_CSC]), [handler.othersPropCreation]);
