...
router.put('/',verifyjwt,roleAuthorization([Roles.Role_User,Roles.Role_CSC,Roles.Role_Sro],true),[handler.updateDocument]);
router.delete('/:documentId',verifyjwt, roleAuthorization([Roles.Role_User,Roles.Role_CSC,Roles.Role_Sro]), validateSchema(documentByIdScheme), [handler.deleteDocument]);
...
router.post('/syncservice/:id', [handler.syncservice]);
...
router.put('/lb/td/update',verifyjwt, roleAuthorization([Roles.Role_User,Roles.Role_Sro]),[handler.updateTdHandler]);

//SLOt VErify through QR
router.put('/statushstr/:sd/:documentid',verifyjwt,roleAuthorization([Roles.Role_User,Roles.Role_Sro]),[handler.updateStatusHstr]);
...
router.get('/readyToEsign/list',verifyjwt,roleAuthorization([Roles.Role_User]), [handler.getDocsForEsign])
router.put('/lb/td/update',verifyjwt, roleAuthorization([Roles.Role_User,Roles.Role_CSC,Roles.Role_Sro]),[handler.updateTdHandler])
router.put('/statushstr/:sd/:documentid',verifyjwt,roleAuthorization([Roles.Role_User,Roles.Role_Sro]),[handler.updateStatusHstr]);
